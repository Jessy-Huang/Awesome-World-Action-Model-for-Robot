...
**World Model 流**:
1. Dreamer 系列 (Hafner et al., 2019-2023)
...
| [DreamerV3](https://github.com/danijar/dreamerv3) | JAX | 高 | ⭐⭐⭐⭐ |
...
### Q1: World Model 和 LLM 中的 World Model 一样吗？
...
- [HuggingFace Robotics Blog](https://huggingface.co/blog/robotics)
- [Google Robotics Blog](https://blog.research.google/technology/robotics/)
- [Physical Intelligence Blog](https://www.physicalintelligence.company/)
- [Toyota Research Institute Blog](https://www.tri.co.jp/)

### 8.3 开发者社区

- [LeRobot Discord](https://discord.gg/huggingface)
- [r/robotics](https://reddit.com/r/robotics)
- [Stack Overflow Robotics](https://robotics.stackexchange.com/)
